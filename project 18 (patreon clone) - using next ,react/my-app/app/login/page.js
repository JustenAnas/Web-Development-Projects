...
const Login = () => {
  ...
  return (
    <div className="text-white py-11 container mx-auto">
        ...
        <main className="flex items-center justify-center text-white">
          <section className="w-[25rem] flex flex-col space-y-8 p-6 bg-gray-700 bg-opacity-5 rounded-md shadow-lg">
            ...
            <a
              ...
              className="text-center font-medium text-gray-400 hover:text-gray-300 transition duration-300"
            >
              FORGOT PASSWORD?
            </a>
      ...
      <div className="bg-gray-700 bg-opacity-5 text-center font-medium text-2xl text-white mx-auto w-[25rem]">
        or
      </div>
