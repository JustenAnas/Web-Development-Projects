        ...
        >
          <ul
            ...
            style={{
              ...
              fontsize: "18px",
              fontfamily: "Link Sans",
              fontWeight: "500",
              cursor: "pointer",
            }}
          >
            <Link href="/">
              <li className="main-item">Templates</li>
            </Link>

            <Link href="/">
              <li className="main-item">MarketPlace</li>
            </Link>

            <Link href="/">
              <li className="main-item">Discover</li>
            </Link>
            ...
            <Link href="/">
              <li className="main-item">Pricing</li>
            </Link>
            <Link href="/">
              <li className="main-item">Learn</li>
            </Link>
            {/* <ul className="hidden-menu">
              <li>Item 1</li>
              <li>Item 2</li>
