...
const page = () => {
  return (
    <div className="bg-white">
      <header className="bg-purple-700 text-white text-center py-12">
      ...
      <section className="text-center py-12 px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 mt-8 animate-fadeIn">
          <div className="p-4 shadow-lg rounded-lg bg-yellow-100 hover:bg-purple-200 transition-colors">
            <h3 className="text-xl font-bold">Call Us</h3>
            <p className="text-gray-700 mt-2">+91 8545874928</p>
          </div>
          <div className="p-4 shadow-lg rounded-lg bg-yellow-100 hover:bg-purple-200 transition-colors">
        ...
        <form className="max-w-2xl mx-auto mt-8 space-y-8">
          <div>
            ...
            <input
              type="text"
              id="name"
              className="w-full mt-2 p-3 border rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-purple-500 transition"
            />
          </div>
          <div>
          ...
          <button
            type="submit"
            className="w-full bg-purple-700 text-white py-3 rounded-lg shadow-lg hover:bg-purple-600 transition-colors"
          >
            Send Message
          </button>
        </form>
      ...
      <footer className="bg-purple-700 text-white text-center py-8">
        <p>
          &copy; Copyright BitLinks 2024 . All rights reserved. Made By Binary
          Boats⛵.
        </p>
      </footer>
    </div>
